package com.ktsnwt.Culturalcontentapp.config;

import com.ktsnwt.Culturalcontentapp.security.AuthTokenUtils;
import com.ktsnwt.Culturalcontentapp.security.auth.AuthEntryPoint;
import com.ktsnwt.Culturalcontentapp.security.auth.TokenAuthenticationFilter;
...
//                // umetni custom filter TokenAuthenticationFilter kako bi se vrsila provera JWT tokena umesto cistih korisnickog imena i lozinke (koje radi BasicAuthenticationFilter)
                .addFilterBefore(new TokenAuthenticationFilter(tokenUtils, customUserDetailService),
